...
public class MapChunkPacketModifier extends PacketModifier<PacketPlayOutMapChunk> {
	private static Field xCoordField;
	private static Field zCoordField;
	private static Field chunkMapField;

	@Override
	public boolean modify(PacketPlayOutMapChunk packet, VirtualEnvironment environment) {
		try {
	...
	public static void register() {
		VirtualEnvironment.register(new MapChunkPacketModifier());
	}
